...
<body>
    ...
    <div class="container">
        <div class="col-lg-12 col-md-8">
            <div style="height:20em" class="panel profile-cover">
                <div class="profile-cover__img">
                    <img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt="" />
                    <h3 class="h3" style="font-weight:bold; font-size:1.2rem;">{{ Auth::user()->first_name }} {{
                        Auth::user()->last_name }} </h3>
                    <a href="{{ route('update',  Auth::user()->id) }}" class="button">Update Profile</a>
                </div>
                <div class="cover">
            ...
            <div class="panel">
                ...
                <div class="panel-content panel-activity">
                    <form action="#" class="panel-activity__status">
                        <textarea name="user_activity" placeholder="What do you think?"
                        ...
                        <div class="actions">
                            ...
                            <button type="submit" style="background:#2a3a50; padding:2px 20px 2px 20px; color:white; font:bold;" class="btn btn-sm btn-rounded">
                                Post
                            </button>
                        </div>
                    </form>
    ...
    <style>
        ...
        .profile-cover__action {
            ...
            overflow: hidden;
            background: url({{ asset('logo/dits-text.png') }}) no-repeat;
